...
if (isset($_POST['objid'])) {
    ...
    $get_all_history_sql = "SELECT t.objidmas,t.id,t.datepayment,t.ornomas,t.amountmas from masdailypayment t inner join registration r on r.objid = t.id WHERE t.id = '" . $objid . "' AND t.status = 'ACTIVE' order by t.objidmas DESC";
