...
$get_company_sql = "SELECT * FROM tbl_company where status='ACTIVE' order by id DESC";
...
<body class="hold-transition sidebar-mini">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body" style="padding: 30px;">
                  ...
                  <form method="POST" action="insert_payroll_weekly.php">
                    ...
                    <div class="row g-3">
                      <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="mb-3">
                          ...
                          <input readonly type="text" class="form-control" id="emp_id5" name="emp_id5" placeholder="">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-8 col-md-4 col-sm-6">
                        <div class="mb-3">
                          ...
                          <input readonly type="text" class="form-control" id="emp_fullname" name="emp_fullname" placeholder="">
                        </div>
                      </div>
                    ...
                    <div class="row g-3">
                      <div class="col-md-12">
                        <label for="get_schedule">Address: </label>
  ...
  <div class="modal fade" id="delete_payslip" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <form method="POST" action="delete_payslip.php">
  ...
  <a class="dropdown-item d-flex align-items-center" id="print_payroll" href="#" title="Print Payroll">
    ...
    $("#users tbody").on("click", "#print_payroll", function(event) {
      ...
      var payroll_id = currow.find("td:eq(0)").text().trim(); // get employee ID

      // Open the pay slip in a new tab
      var url = "../plugins/TCPDF/User/weekly_payslip.php?payroll_id=" + payroll_id;
    ...
    $(function() {
      $(document).on('click', '.delete', function(e) {
        ...
        var currow = $(this).closest("tr");
        var payslip_id = currow.find("td:eq(0)").text();
