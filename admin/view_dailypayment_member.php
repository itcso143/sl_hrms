...
$get_data_data = $con_fscap2->prepare($get_data_sql);
...
$get_all_preby_data = $con_fscap2->prepare($get_all_preby_sql);
                      ...
                      <div class="box-body">
                        <div class="row">
                          <div class="col-12" style="margin-bottom:30px;padding:auto;">
                            ...
                            <button id="view_payment" onClick="viewpayment()" class="btn btn-warning">VIEW PAYMENT</button>
                            </div>
                          </div>


                          <label style="padding-right:10px;padding-left: 10px">TOTAL AMOUNT: </label>
...
<br>
  ...
  <script>
    ...
    function viewpayment() {
      ...
      $('#daily_payment').load("load_viewpayment.php", {
          objid: objid
