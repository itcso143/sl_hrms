...
<tr>
  <td width="100%">
    ...
    <strong>Pay Date:</strong> ' . $date_create_salary . '<br>
...
<tr>
  <td>Basic Salary</td>
  <td align="center">' . $emp_quantity . '</td>
  <td align="right">' . $emp_rate . '</td>
  <td align="right">' . $emp_total . '</td>
</tr>
</table>
