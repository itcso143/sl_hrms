...
$html .= '
        ...
        ';
//select all users
$get_all_ordinances_sql = "SELECT * FROM ordinances WHERE OrdinanceNumber!= OrdinanceNumber";
$get_all_ordinances_data = $con->prepare($get_all_users_sql);
$get_all_ordinances_data->execute([':id'=>$_SESSION['id']]);
