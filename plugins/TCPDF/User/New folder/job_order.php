...
$schedule=$_GET['JobOrderNo'];
 ...
 while ($result = $get_schedule_data1->fetch(PDO::FETCH_ASSOC)) {
    ...
    $jo_day2 = $result['RegDays2'];
    $jo_time = $result['Time1'];
    $jo_time_1 = $result['Time1_am_out'];
    $jo_time_2 = $result['Time1_pm_in'];
    $jo_time_3 = $result['Time1_pm_out'];
    $jo_total = $result['no'];
                ...
                <tbody>
                    ...
                    <td width="18%" style="font-size:12px;">'. $jo_lname.'</td>
                      <td width="3%" style="text-align:center; font-size:12px">'.','.'</td>
                       <td width="17%" style="font-size:12px;">'. $jo_fname.'</td>
                       <td width="5%" style="text-align:center; font-size:12px">'. $jo_mname[0].'.'.'</td>
                    <td width="50%" style="text-align:center; font-size:11px">'.$jo_period.' '.' '.$jo_days1.'-'.$jo_days2.','.'  '.$jo_year.' '.'@'.' '.$jo_rate.''.'/day'.' '.'<br>'.$jo_time.''.'-'.''.$jo_time_1.''.'/'.$jo_time_2.''.'-'.''.$jo_time_3.''.'('.$jo_sched.')'.'    
                    <br>
                      '.$jo_month1.' '.' '.$jo_days2.','.' '.$jo_year.' '.'@'.' '.$jo_rate1.''.'/day'.' '.$jo_time1.'('.$jo_sched1.')'.'
                     </td>
                   </tr>                 
...
elseif ($jo_period!="" && $jo_month1=="" && $jo_month2==""  && $jo_time!="" && $jo_time_1!="" && $jo_time_2!="" && $jo_time_3!=""){
$html .= '
                <tbody>
                    <tr>
                    <td width="8%" style="text-align:center; font-size:12px;">'. $n++.'</td>
                    <td width="18%" style="font-size:12px;">'. $jo_lname.'</td>
                      <td width="3%" style="text-align:center; font-size:11px">'.','.'</td>
                       <td width="17%" style="font-size:12px;">'. $jo_fname.'</td>
                       <td width="5%" style="text-align:center; font-size:12px">'. $jo_mname[0].'.'.'</td>
                    <td width="50%" style="text-align:center; font-size:11px">'.$jo_period.' '.' '.$jo_days1.'-'.$jo_day2.','.'  '.$jo_year.' '.'@'.' '.$jo_rate.''.'/day'.' '.'<br>'.$jo_time.''.'-'.''.$jo_time_1.''.'/'.$jo_time_2.''.'-'.''.$jo_time_3.''.'('.$jo_sched.')'.'    
                     </td>
                   </tr>                 
                ...
                <tbody>
                    ...
                    <td width="18%" style="font-size:12px;">'. $jo_lname.'</td>
                      <td width="3%" style="text-align:center; font-size:11px">'.','.'</td>
                       <td width="17%" style="font-size:12px;">'. $jo_fname.'</td>
                       <td width="5%" style="text-align:center; font-size:12px">'. $jo_mname[0].'.'.'</td>
                    <td width="50%" style="text-align:center; font-size:11px">'.$jo_period.' '.' '.$jo_days1.'-'.$jo_day2.','.'  '.$jo_year.' '.'@'.' '.$jo_rate.''.'/day'.' '.'<br>'.$jo_time.''.'-'.''.$jo_time_3.''.'('.$jo_sched.')'.'    
                     </td>
                   </tr>                 
                ...
                <tbody>
                    ...
                    <td width="18%" style="font-size:12px;">'. $jo_lname.'</td>
                      <td width="3%" style="text-align:center; font-size:11px">'.','.'</td>
                       <td width="17%" style="font-size:12px;">'. $jo_fname.'</td>
                       <td width="5%" style="text-align:center; font-size:12px">'. $jo_mname[0].'.'.'</td>
                    <td width="50%" style="text-align:center; font-size:11px">'.$jo_period.' '.' '.$jo_days1.'-'.$jo_day2.','.'  '.$jo_year.' '.'@'.' '.$jo_rate.''.'/day'.' '.'<br>'.$jo_time.''.'-'.''.$jo_time_1.''.'('.$jo_sched.')'.'    
                     </td>
                   </tr>                 
                ...
                <tbody>
                    ...
                    <td width="18%" style="font-size:12px;">'. $jo_lname.'</td>
                      <td width="3%" style="text-align:center; font-size:11px">'.','.'</td>
                       <td width="17%" style="font-size:12px;">'. $jo_fname.'</td>
                       <td width="5%" style="text-align:center; font-size:12px">'. $jo_mname[0].'.'.'</td>
                    <td width="50%" style="text-align:center; font-size:11px">'.$jo_period.' '.' '.$jo_days1.'-'.$jo_day2.','.'  '.$jo_year.' '.'@'.' '.$jo_rate.''.'/day'.' '.'<br>'.$jo_time_2.''.'-'.''.$jo_time_1.''.'('.$jo_sched.')'.'    
                     </td>
                   </tr>                 
