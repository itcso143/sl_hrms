...
$get_nojo_sql= "SELECT COUNT(ID) as total FROM employeedetail WHERE DeptCharge = '$id_em'";
...
$html .= '
          ...
          <thead>
           ...
           <tr bgcolor="lightblue" >
              ...
              <th  width="18%" style="text-align:center;"><b>NAME</b></th>
              ...
              <th  width="15%" style="text-align:center;"><b>FUNCTION/POSITION</b></th>
...
if( $get_emp_dept_charge==$id_emp){
    $n = 1;
    $id_emp = $_GET['DeptCharge'];  
    $get_emp_data_sql = "SELECT * FROM employeedetail where DeptCharge= :DeptCharge  ORDER BY EmpLname  ASC";
...
if ($get_emp_fname!="" AND $get_emp_lname!="" AND $get_emp_mname!="" AND $get_emp_ename!="" AND $id_no1!=1 AND $get_status=="Active") { 
        ...
        <tbody>
            ...
            <td width="18%">'.$get_emp_lname.','.' '.$get_emp_fname.' '.$get_emp_mname[0].'.'.','.' '.$get_emp_ename.'</td>
            ...
            <td width="15%" style="text-align:center">'.$get_emp_designation.'</td>
...
$html .= '
         ...
         <tbody>
            <tr>
            <td width="3%" style="text-align:center">'.$n++.'</td>
            <td width="18%">'.$get_emp_lname.','.' '.$get_emp_fname.' '.$get_emp_mname[0].'.</td>
            <td width="5%" style="text-align:center">'.$get_emp_gender.'</td>
            <td width="3%" style="text-align:center">'.$get_age.'</td>
             <td width="6%" style="text-align:center">'.$get_emp_birth.'</td>
            <td width="20%"> '. $get_emp_address.'</td>
...
$html .= '
         ...
         <tbody>
            <tr>
            <td width="3%" style="text-align:center">'.$n++.'</td>
            <td width="18%">'.$get_emp_lname.','.' '.$get_emp_fname.','.' '.$get_emp_ename.'</td>
            <td width="5%" style="text-align:center">'.$get_emp_gender.'</td>
            <td width="3%" style="text-align:center">'.$get_age.'</td>
             <td width="6%" style="text-align:center">'.$get_emp_birth.'</td>
            <td width="20%"> '. $get_emp_address.'</td>
...
$html .= '
         ...
         <tbody>
            <tr>
            td width="3%" style="text-align:center">'.$n++.'</td>
            <td width="18%">'.$get_emp_lname.','.' '.$get_emp_fname.'</td>
            <td width="5%" style="text-align:center">'.$get_emp_gender.'</td>
            <td width="3%" style="text-align:center">'.$get_age.'</td>
             <td width="6%" style="text-align:center">'.$get_emp_birth.'</td>
            <td width="20%"> '. $get_emp_address.'</td>
