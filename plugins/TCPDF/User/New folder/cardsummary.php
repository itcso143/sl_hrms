...
$jo_no=$_GET['EmpCode'];
    $get_jo_sql ="SELECT * FROM schedule where EmpCode = :EmpCode";
    $get_jo_data1 = $con->prepare($get_jo_sql);
    $get_jo_data1->execute([':EmpCode' => $jo_no]);    
    ...
    $month1 = $result['Period'];
    $days1 = $result['RegDays'];
    $year1 = $result['Years'];; 
    $time1 = $result['Time1'];
...
$html .= '
                ...
                <tbody>
                    <tr>
                    <td width="8%" style="text-align:center;font-size:12px;">'. $jo_total.'</td>
