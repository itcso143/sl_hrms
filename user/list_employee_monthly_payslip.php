...
<body class="hold-transition sidebar-mini">
  ...
  <script>
    var dataTable = $('#users').DataTable({
      ...
      ajax: {
        url: "search_my_payslip_monthly.php",
        type: "POST",
  ...
  <a class="dropdown-item d-flex align-items-center" id="print_payroll" href="#" title="Print Payroll">
    <i class="fa fa-print me-2 text-danger"></i> Print
  </a>
</li>
        </ul>
      </div>
    `
     ...
     $("#users tbody").on("click", "#print_payroll", function(event) {
      ...
      var url = "../plugins/TCPDF/User/pay_slip.php?salary_id=" + payroll_id;
