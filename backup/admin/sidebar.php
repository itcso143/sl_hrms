    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
      ...
      <ul class="navbar-nav w-100">
        ...
        <li class="nav-item w-100 text-center mb-1">
          <button type="button" class="btn btn-primary px-4 py-2" data-bs-toggle="modal" data-bs-target="#timeInModal">Daily Logs</button>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <h5 class="modal-title" id="timeInModalLabel">Daily Logs</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <!-- MODAL BODY -->
            <div class="modal-body text-center">
              <p>Click confirm to log your time.</p>
            ...
            <!-- MODAL FOOTER -->
            <div class="modal-footer py-3"> <!-- vertical padding -->
              <div class="row justify-content-center text-center"> <!-- center buttons -->
                <div class="col-auto">
                  <button type="button" id="save_time_in" name="save_time_in" class="btn btn-primary px-3">Time In</button>
                </div>

                <div class="col-auto">
                  <button type="button" id="save_time_breakout" name="save_time_breakout" class="btn btn-primary px-3">Break Out</button>
                </div>

                <div class="col-auto">
                  <button type="button" id="save_time_breakin" name="save_time_breakin" class="btn btn-primary px-3">Break In</button>
                </div>

                <div class="col-auto">
                  <button type="button" id="save_time_lunchout" name="save_time_lunchout" class="btn btn-primary px-3">Lunch Out</button>
                </div>

                <div class="col-auto">
                  <button type="button" id="save_time_lunchin" name="save_time_lunchin" class="btn btn-primary px-3">Lunch In</button>
                </div>

                <div class="col-auto">
                  <button type="button" id="save_time_out" name="save_time_out" class="btn btn-primary px-3">Time Out</button>
                </div>
              </div>
            </div>
