...
while ($result4 = $user_data->fetch(PDO::FETCH_ASSOC)) {
    ...
    $bank_account_type = $result4['bank_account_type'];
    $bank_holder_name = $result4['bank_holder_name'];
    ...
    $net_pay = $result4['net_pay'];
     $weekly_salary = $result4['weekly_salary'];
            ...
            <section class="content">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form role="form" enctype="multipart/form-data" method="post" id="input-form" action="update_employee.php">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <select class="form-control select2" id="get_user_type" name="get_user_type">
                                                        <?php while ($get_usertype = $get_all_usertype_data->fetch(PDO::FETCH_ASSOC)) {
                                                            $selected = ($get_user_type == $get_usertype['user_type']) ? 'selected' : '';
                                                        ?>
                                                            <option <?= $selected; ?> value="<?php echo $get_usertype['user_type']; ?>">
                                                                <?php echo $get_usertype['user_type']; ?>
                                                            </option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                <h5 class="text-center">BANK INFO.</h5>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-5">
                                                    <!-- <label>Street: </label> -->
                                                    <input type="text" class="form-control" name="bank_account_type" placeholder="Bank Account Type" value="<?php echo $bank_account_type; ?>">
                                                    <span>Bank Account Type</span>
                                                </div>
                                                <div class="col-md-5">
                                                    <!-- <label>Street: </label> -->
                                                    <input type="text" class="form-control" name="bank_holder_name" placeholder="Bank Holder Name" value="<?php echo $bank_holder_name; ?>">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <span>Emergency Person Name</span>
                                                </div>
                                                <div class="col-md-5">
                                                    <!-- <label>Street: </label> -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <span>Emergency Person Contact No.</span>
                                                </div>
                                    ...
                                    <div class="card col-md-5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <input type="text" class="form-control" name="net_pay" placeholder="Basic Salary" value="<?php echo $net_pay; ?>">
                                            </div>
                                           ...
                                           <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <input type="text" class="form-control" name="weekly_salary" placeholder="Weekly Salary" value="<?php echo $weekly_salary; ?>">
                                            </div>
                                             </div>
                                            <br>
                                        ...
                                        <div class="box-footer" align="center">
                                            ...
                                            <button type="submit" <?php echo $btnSave; ?> name="update_employee" id="btnSubmit" class="btn btn-success">
                                                <i>Update </i> </button>
