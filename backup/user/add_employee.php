                                    ...
                                    <div class="card col-md-6">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <label>Age:</label>
                                                    <input type="number" id="ages" name="age" class="form-control" placeholder="Age" value="<?php echo $age ?>">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <!-- <label>Street: </label> -->
                                                    <input type="text" class="form-control" name="address" placeholder="Street / Lot # / Block #" value="<?php echo $street; ?>" >
                                                </div>
                                            </div><br>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <!-- <label>Street: </label> -->
                                                    <input type="text" class="form-control" name="barangay" placeholder="Barangay" value="<?php echo $street; ?>" >
                                                </div>
                                            </div><br>
