...
if (isset($_POST['emp_id'])) {
    ...
    $get_all_employeelogs_sql = "SELECT emp_id,date_logs,punch_in,punch_out FROM tbl_employee_timelogs WHERE emp_id = '" . $emp_id . "' AND date_logs BETWEEN '$date_from' AND '$date_to'  order by id DESC";
